    ...
    <div className="bg-white border border-line rounded-xl p-4">
      ...
      <div className="flex items-center justify-between mb-3">
        <button
          ...
          onClick={prevMonth}
          disabled={!canGoPrev()}
          className="w-8 h-8 flex items-center justify-center rounded-lg text-[#171a20] hover:bg-black/[0.05] transition-all duration-200 disabled:opacity-25 disabled:cursor-not-allowed"
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
        </button>
        <span className="font-display font-semibold text-[#171a20] text-sm tracking-wide">
          {MONTHS_FULL[month]} {year}
        </span>
        <button
          type="button"
          onClick={nextMonth}
          className="w-8 h-8 flex items-center justify-center rounded-lg text-[#171a20] hover:bg-black/[0.05] transition-all duration-200"
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
      ...
      <div className="grid grid-cols-7 mb-1">
        {DAY_HEADERS.map((h) => (
          <div key={h} className="text-center text-[10px] font-semibold tracking-widest py-1.5 uppercase text-text-muted">
            {h}
          </div>
        ))}
      </div>
            ...
            <button
              ...
              className={`
                ...
                ${selected
                  ...
                  : available
                  ? 'text-[#171a20] border border-line hover:border-[#171a20] hover:bg-black/[0.03]'
      ...
      <div className="flex items-center gap-5 mt-3 pt-3 border-t border-line">
        <div className="flex items-center gap-1.5">
          <div className="w-2.5 h-2.5 rounded border border-line bg-white" />
          <span className="text-text-muted text-[10px]">Disponible</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2.5 h-2.5 rounded bg-[#171a20]" />
          <span className="text-text-muted text-[10px]">Sélectionné</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2.5 h-2.5 rounded bg-[#f0f0f0]" />
...
export default function Contact() {
  ...
  const inputClasses =
    'w-full bg-[#f4f4f4] border border-line rounded-lg px-4 py-3 text-[#171a20] placeholder-text-muted text-sm focus:outline-none focus:border-[#171a20] focus:bg-white transition-all duration-200'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <h2 className="font-display text-4xl sm:text-5xl font-semibold text-[#171a20] tracking-tight mb-6 leading-tight">
            ...
            <p className="text-text-secondary text-base leading-relaxed mb-10">
              ...
              Disponibles <strong className="text-[#171a20]">le week-end uniquement</strong> — réservez votre créneau
            ...
            <div className="space-y-5 mb-10">
              {contactInfo.map((item) => (
                <div key={item.label} className="flex gap-4 items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-[#f4f4f4] border border-line flex items-center justify-center text-[#171a20]">
                    {item.icon}
                  </div>
                  <div>
                    ...
                    {item.href ? (
                      <a
                        ...
                        className="text-[#171a20] text-sm hover:underline font-medium"
                      >
                        {item.value}
                      </a>
                    ) : (
                      <div className="text-[#171a20] text-sm">{item.value}</div>
                    )}
                  </div>
                </div>
              ))}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-3 px-6 py-4 rounded-2xl border border-line hover:border-[#171a20] transition-all duration-300"
            >
              ...
              <div>
                ...
                <div className="text-[#171a20] font-display font-bold text-lg tracking-wide">@ai-clean</div>
              </div>
            </a>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-2xl p-8 border border-line shadow-[0_4px_30px_rgba(0,0,0,0.05)]">
              {!submitted ? (
                <>
                  <h3 className="font-display text-xl font-semibold text-[#171a20] mb-1">
                    Réserver un créneau
                  </h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                            ...
                            return (
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 ${
                                  selected
                                    ? 'bg-[#171a20] text-white border border-[#171a20]'
                                    : 'bg-white border border-line text-text-secondary hover:border-[#171a20] hover:text-[#171a20]'
                                }`}
                              >
                                {slot}
                              </button>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="btn-dark w-full py-3.5 rounded-full font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-[#171a20] flex items-center justify-center">
                    <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <h3 className="font-display text-xl font-semibold text-[#171a20]">Demande envoyée !</h3>
                  <p className="text-text-secondary text-sm max-w-xs leading-relaxed">
                    Merci <strong className="text-[#171a20]">{form.name}</strong> — on vous recontacte au plus vite
                    pour confirmer votre créneau.
                    {form.date && form.time && (
                      <span className="block mt-2 text-[#171a20] font-medium">
                  ...
                  <button
                    ...
                    className="text-text-muted text-xs hover:text-[#171a20] transition-colors mt-1"
                  >
                    Nouvelle demande
                  </button>
                </motion.div>
