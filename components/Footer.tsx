...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-background-secondary border-t border-line">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <div className="flex flex-col leading-none">
                <span className="font-display font-semibold text-base text-[#171a20]">
                  A&amp;I Clean
                </span>
          ...
          {/* Prestations */}
          <div>
            <h4 className="font-display font-semibold text-[#171a20] text-sm mb-4 tracking-wide">Prestations</h4>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item}>
                  <Link href="#services" className="text-text-secondary text-sm hover:text-[#171a20] transition-colors duration-200">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact rapide */}
          <div>
            <h4 className="font-display font-semibold text-[#171a20] text-sm mb-4 tracking-wide">Contact</h4>
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-text-secondary text-sm hover:text-[#171a20] transition-colors duration-200"
                >
                  <span className="w-5 h-5 rounded-full bg-[#FFFC00] flex items-center justify-center flex-shrink-0">
              ...
              <li className="flex items-start gap-2.5 text-text-secondary text-sm">
                <svg className="w-4 h-4 text-[#171a20] flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-text-muted text-xs">
          ...
          <div className="flex gap-6">
            <Link href="#" className="hover:text-[#171a20] transition-colors duration-200">Mentions légales</Link>
            <Link href="#" className="hover:text-[#171a20] transition-colors duration-200">CGV</Link>
          </div>
        </div>
      </div>
    </footer>
